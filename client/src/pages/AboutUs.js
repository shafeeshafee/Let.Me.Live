...
function AboutUs() {
  ...
  const GitHub = <FontAwesomeIcon icon={faGithub} />;
    ...
    <h2 className="text-4xl font-bold font-bodySans py-10 ">LET. ME. LIVE.  is an independent service for reporting tenant harassment in New York City.</h2>
  </div>
  <div className="flex flex-wrap xl:w-1/3 p-10 justify-center">
    <h3 className="text-3xl font-bold font-bodySans py-5">Purpose
    </h3>
        <ul>
            <li className="text-2xl font-bodySans py-3">To help end tenant harassment against low-income New Yorkers by making unfair housing practices visible and open to accountability.</li>
          </ul>
          <ul>
            <h3 classname="text-3xl font-bold font-bodySans py-10">LET. ME. LIVE. Team</h3>
          <div className="team">
          <div className="team-role">
              {/* <img src={shafee} alt="profile" /> */}
